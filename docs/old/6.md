...
3. **Um contrato de use-case** — HTTP, UI e agents consomem a mesma aplicação de serviço (já iniciado nos use-cases Nest).
...
| **Experience** | `ui-external`, `ui-internal` (futuro shell único) | APIs dos módulos |
